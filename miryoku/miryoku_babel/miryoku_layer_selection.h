...
#include "miryoku_layer_alternatives.h"
      ...
      #if defined (MIRYOKU_DVORAK_SWAP)
        #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_DVORAK_SWAP_FLIP
      #else
    ...
    #elif defined (MIRYOKU_ALPHAS_DVORAK)
      #if defined (MIRYOKU_DVORAK_SWAP)
        #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_DVORAK_SWAP
      #else
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
      ...
      #if defined (MIRYOKU_DVORAK_SWAP)
        #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_DVORAK_SWAP_FLIP
      #else
    ...
    #elif defined (MIRYOKU_EXTRA_DVORAK)
      #if defined (MIRYOKU_DVORAK_SWAP)
        #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_DVORAK_SWAP
      #else
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
      ...
      #if defined (MIRYOKU_DVORAK_SWAP)
        #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_DVORAK_SWAP_FLIP
      #else
    ...
    #elif defined (MIRYOKU_TAP_DVORAK)
      #if defined (MIRYOKU_DVORAK_SWAP)
        #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_DVORAK_SWAP
      #else
  ...
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_DVORAK_SWAP)
      #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_DVORAK_SWAP_FLIP
    #else
      #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_FLIP
    #endif
  #else
    #if defined (MIRYOKU_DVORAK_SWAP)
      #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_DVORAK_SWAP
    #else
  ...
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_DVORAK_SWAP)
      #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_DVORAK_SWAP_FLIP
    #else
      #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_FLIP
    #endif
  #else
    #if defined (MIRYOKU_DVORAK_SWAP)
      #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_DVORAK_SWAP
    #else
